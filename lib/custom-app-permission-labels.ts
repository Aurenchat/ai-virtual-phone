...
export const PERMISSION_LABELS: Record<string, string> = {
  ...
  "ai.chat": "自由调用对话模型",
  "ai.generateScoped": "使用显式来源策略进行多模态角色生成",
  "ai.tasks": "后台执行并持久保存 AI 任务结果（消耗模型额度）",
  "app.policy.manage": "注册持久全局模型保护规则（影响所有模型请求，失败时阻止发送）",
  "memory.source.read": "读取本 APP 按角色和来源隔离的记忆投影",
  "memory.source.write": "写入及撤销本 APP 的长期记忆投影",
  "ai.embed": "调用向量嵌入模型",
